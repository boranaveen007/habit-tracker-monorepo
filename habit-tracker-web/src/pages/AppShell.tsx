...
export default function AppShell() {
  ...
  const [view, setView] = useState<"today" | "week" | "month" | "analytics">(initialView as any);
      ...
      <nav className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-slate-100 px-6 py-4">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-emerald-500 rounded-lg flex items-center justify-center text-white font-bold shadow-sm">H</div>
            <h1 className="text-xl font-bold tracking-tight text-slate-800">HabitTracker</h1>
          </div>
